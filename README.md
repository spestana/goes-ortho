...
<img src="docs/examples/make_abi_timeseries_example_plot.png" width="600">
...
See [make_abi_timeseries_example.ipynb](docs/examples/make_abi_timeseries_example.ipynb) jupyter notebook.
